...
# The required parameter keys for the tool/query-context. Used by EXECUTOR to
# force Gemini's structured JSON output to include every field the pipeline
# expects (table_name, fields, time_range_hours, the three booleans, etc.).
TOOL_PARAM_KEYS = TOOLS[0]["function"]["parameters"]["required"]
